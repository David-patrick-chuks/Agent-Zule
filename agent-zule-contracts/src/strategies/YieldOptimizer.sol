...
contract YieldOptimizer is AccessControl, ReentrancyGuard {
     ...
     * @return deposits Total deposits across all users
     * @return rewards Total rewards generated
     ...
     */
    function setEmergencyStop(string calldata reason) external onlyRole(ADMIN_ROLE) {
        emergencyStop = true;
