...
contract VotingEngine is IVotingEngine, AccessControl, ReentrancyGuard, Pausable {
     ...
     * @return delegate Address that voting power is delegated to
     */
    function getVotingPower(address voter) external view override returns (uint256 power, address delegate) {
